      ...
      <div className="flex items-start gap-2.5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-2 flex flex-wrap items-center gap-1.5">
            <span className={`rounded-md px-2 py-0.5 text-[12px] font-semibold ${config.bg}`}>
              {config.label}
            </span>
            {criterion.aiDetermined ? (
              <span className="flex items-center gap-1 rounded-md bg-purple-500/10 px-2 py-0.5 text-[12px] font-medium text-purple-400">
                <Brain className="h-2.5 w-2.5" />
                AI {Math.round(criterion.confidence * 100)}%
              </span>
            ) : (
              <span className="flex items-center gap-1 rounded-md bg-surface-2 px-2 py-0.5 text-[12px] font-medium text-dim">
            ...
            <div className="mt-3">
              {criterion.evidence && (
                <div className="rounded-md bg-surface-2 p-2.5 ring-1 ring-edge-2">
                  ...
                  <p className="mt-1 text-[12px] leading-relaxed text-body">{criterion.evidence}</p>
                  {criterion.reasoning && (
                    <>
                      <p className="mt-2 text-[12px] font-semibold uppercase tracking-wider text-dim">Reasoning</p>
                      <p className="mt-1 text-[12px] leading-relaxed text-dim">{criterion.reasoning}</p>
                    </>
                  )}
                </div>
              )}
  ...
  if (!selectedPatientId) {
    return (
      <div className="flex h-full flex-col items-center justify-center bg-background p-8 text-center">
        ...
        <p className="mt-2 max-w-[260px] text-[12px] leading-relaxed text-dim">
  ...
  if (!patient || !screening) {
    return (
      <div className="flex h-full items-center justify-center bg-background">
        <p className="text-[12px] text-dim">No screening data available for this subject.</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden bg-background">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {/* Inclusion */}
        <div className="mb-5">
          <h4 className="mb-2.5 flex items-center gap-2 text-[12px] font-semibold uppercase tracking-wider text-dim">
      ...
      >
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="rounded-md border border-edge-3 px-3 py-1 text-[12px] font-medium text-dim transition-colors hover:bg-surface-2 hover:text-body"
          >
            Undo
          </button>
        </div>
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={() => setCurrentPage("review")}
            className="flex items-center justify-center gap-1.5 rounded-lg border border-edge-3 bg-surface-2 px-3 py-2 text-[12px] font-medium text-dim transition-colors hover:bg-surface-3 hover:text-body"
            title="Review Queue"
          >
            <ClipboardCheck className="h-3.5 w-3.5" />
          </button>
        ...
        <div>
          <div className="flex items-center justify-between mb-1">
            <span className="text-[12px] text-dim">Review progress</span>
  ...
  return (
    <div className="border-t border-border bg-card/60 px-4 py-4">
      ...
      {reviewProgress.reviewed > 0 && (
        <div className="mb-3 flex items-center justify-between rounded-md bg-surface-1 px-3 py-1.5 ring-1 ring-edge-1">
