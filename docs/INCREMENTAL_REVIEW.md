...
Browser verification (2026-09-13): current approval enabled a successful download with five lifecycle updates and120 target IDs. Inspection preserved corrected/cancelled statuses, null missing results and the less-than comparator. Automated serialized-plan regression checks the complete target and each changed record’s provenance. This is synthetic preservation evidence, not clinical extraction accuracy validation.
